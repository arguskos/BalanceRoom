...
public class Target : MonoBehaviour
{
	...
	void Start ()
	{
        ...
        obj.transform.position = Random.onUnitSphere * GameManager.Instance.Radious;
    ...
    void Update ()
	{
		...
		Center.transform.Rotate(RandomDir * GameManager.Instance.GetParameter(Parameters.ParamsName.TargetSpeed));// [Parameters.Names[(int)Parameters.ParamsName.TargetSpeed]]);
    }
}
